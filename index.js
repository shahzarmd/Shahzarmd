...
let phoneNumber = global.PAIRING_NUMBER || process.env.PAIRING_NUMBER || "923176699066";
let owner = JSON.parse(fs.readFileSync('./data/owner.json'));

global.botname = process.env.BOT_NAME || "SHAHZAR-MD";
global.themeemoji = "•";
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                try {
                 ...
                 await delay(1999);
                console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'SHAHZAR-MD'} ]`)}\n\n`));
                console.log(chalk.cyan(`< ================================================== >`));
                console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: GlobalTechInfo`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: shahzarmd`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: shahzar khan`));
...
async function main() {
    printLog('info', 'Starting SHAHZAR MD BOT...');
